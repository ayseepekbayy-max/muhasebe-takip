        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SenderPerson = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_PrivateMessages_SenderPerson", "\"SenderPerson\" IN (1, 2)");
                });

            migrationBuilder.CreateIndex(
                name: "IX_PrivateMessages_CreatedAtUtc",
